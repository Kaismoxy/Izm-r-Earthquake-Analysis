...
* `capacity.analyse.sql`: Contains the PostgreSQL/PostGIS scripts and Views (e.g., `Capacity_Analyse`) used for the database calculations.
* `README.md`: Project documentation.
* `IzmirMapAssembly.jpg`: Visual output of the QGIS spatial analysis showing safe zones and fault lines.

## 🚀 How to Use
1. Set up a local PostgreSQL database with the PostGIS extension enabled.
2. Run the queries inside `capacity.analyse.sql` to generate the capacity analysis views.
